...
for PFE, JNJ, and MRK. Based on the AIC and BIC criteria, we can see that the GARCH-M-L model is the best model for all three stocks,
followed by the GARCH-M model, and then the GARCH model. Moreover, the log-likelihood values also strengthen 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{q5_panels.png}
    \caption{News impact curves of the three models and the filtered volatilities from the GARCH-M-L model for the four stocks.}
    \label{fig:q5}
\end{figure}
...
=======
\end{document}
>>>>>>> 289187a517bd0276ad02614df8f641d2bdb3a890
